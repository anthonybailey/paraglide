...
---
KI is een krachtige technologie die onze wereld in toenemende mate transformeert.
Het biedt een enorm potentieel, maar ook een aanzienlijk aantal ernstige risico's.
Dit is een poging om alle risico's te benoemen die kunnen worden verminderd door een pauze.
...
We zullen binnenkort mogelijk zien dat sociale media worden overspoeld met nepdiscussies en meningen, en nepnieuwsartikelen die niet te onderscheiden zijn van echte.
...
Je kunt een compilatie van KI-incidenten vinden, die voornamelijk deepfake-nieuws, oplichting en intimidatie zijn, [hier](https://incidentdatabase.ai/summaries/incidents/).

Zoals het gedeelte over nepnieuws zegt, zou nepmedia niet helemaal worden voorkomen door ons voorstel, maar het zou tot op zekere hoogte kunnen worden verminderd.
...
KI vervangt niet alleen onze spieren zoals de stoommachine deed, het vervangt onze hersenen.
Gewone mensen hebben misschien niets meer te bieden aan de economie.
...
Deze KI-relatie-apps zijn [verslavend](https://onlinelibrary.wiley.com/doi/10.1002/mar.21899) gebleken, vooral voor "eenzame kwetsbare mensen".
...
Als we de controle over wapens aan KI delegeren, kunnen fouten en bugs verschrikkelijke gevolgen hebben.
...
Deze positieve feedbacklus kan leiden tot een paar bedrijven of regeringen die een ongezonde hoeveelheid macht hebben.
...
In handen van een autoritaire regering kan dit worden gebruikt om dissidentie te onderdrukken en macht te behouden.
...
Dit type kennis is nog nooit zo toegankelijk geweest, en we hebben niet de waarborgen om de mogelijke gevolgen aan te pakken.
...
We betalen onze boodschappen, plannen onze dagen, contacteren onze geliefden en zelfs rijden onze auto's met computers.
...
Naarmate de mogelijkheden van KI groeien, zullen ook de mogelijkheden van de exploits die ze kunnen creëren groeien.
...
### Menselijke ontmachtiging {#human-disempowerment}

Zelfs als we erin slagen om alleen KI-systemen te creëren die we individueel kunnen controleren, kunnen we onze macht om belangrijke beslissingen te nemen geleidelijk aan verliezen elke keer dat er één wordt opgenomen in instellingen of het dagelijks leven.
...
De technische kennis die nodig is om deze systemen te wijzigen, kan in de eerste plaats ontbreken of in de loop van de tijd verloren gaan, omdat we steeds afhankelijker worden van technologie en de technologie steeds complexer wordt.
...
Het probleem is dat, gezien onze huidige gebrek aan kennis over bewustzijn en de aard van neurale netwerken, we geen manier zullen hebben om te bepalen of sommige KI's enige vorm van ervaring hebben en wat de kwaliteit van die ervaringen zou afhangen van.
...
Die wezens kunnen mensen, dieren, digitale mensen of andere buitenaardse soorten zijn die de KI in het heelal kan vinden. Gezien hoe moeilijk we denken