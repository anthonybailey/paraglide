...
- **Domeinexpertise**: o3 [beantwoordt 87,7%](https://openai.com/index/learning-to-reason-with-llms/) van de GPQA-diamantvragen correct, beter dan menselijke domeinexperts (PhD's) die slechts 69,7% behalen.
- **Visuele redenering**: o3 behaalde een score van [87,5% op de ARC-AGI-benchmark](https://arcprize.org/blog/oai-o3-pub-breakthrough) (menselijk gemiddelde is 60%), die specifiek was ontworpen om moeilijk te zijn voor grote taalmodellen.
...
- **IQ-tests**: Bij verbale IQ-tests hebben LLM's al enige tijd 95 tot 99% van de mensen overtroffen (score tussen [125](https://medium.com/@soltrinox/the-i-q-of-gpt4-is-124-approx-2a29b7e5821e) en [155](https://www.scientificamerican.com/article/i-gave-chatgpt-an-iq-test-heres-what-i-discovered/)). Bij non-verbale (patroonherkenning) IQ-tests scoorde het 2024 o1-preview model [120 op de Mensa-test](https://www.maximumtruth.org/p/massive-breakthrough-in-ai-intelligence), waarmee 91% van de mensen werd overtroffen.
...
- **"Ik weet het niet" zeggen**. Bijna alle Large Language Models hebben dit probleem van 'hallucinatie', het verzinnen van informatie in plaats van te zeggen dat ze het niet weten. Dit is een belangrijke beperking, omdat het de betrouwbaarheid en toepasbaarheid van LLM's sterk beperkt. Echter, studies [laten zien](https://arxiv.org/html/2403.04307v1) dat grotere modellen minder hallucineren dan kleinere.
