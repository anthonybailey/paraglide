...
Effektive lokale Organisation kann viel wirkungsvoller sein als ineffektive lokale Organisation. Wir haben gesehen, welche Auswirkungen effektive Organisation haben kann, wie es von den Graswurzelbewegungen gezeigt wurde, die den Lauf der Geschichte verändert haben. Mit anderen Worten, es ist wichtig, dies richtig zu machen.

Dieser Leitfaden wird Sie durch die Vor- und Nachteile der lokalen Organisation führen, wie z.B. die Rekrutierung von Freiwilligen, die Veranstaltung von Events, den Aufbau von Koalitionen und vieles mehr. Sie sollten aus diesem Leitfaden mit diesen Werkzeugen und vorbereitet auf die Rolle eines lokalen Organisators hervorgehen.
...
4. **Eine Schulung absolvieren**. Es gibt [über 70 Organisationen](https://activisthandbook.org/trainings) auf der ganzen Welt, die Sie oder Ihre Gruppe schulen können!
...
Dies kann zu unkoordinierten Organisationsbemühungen führen, die weniger effektiv sind, als sie sein könnten.
...
- An Nachrichtenagenturen schreiben
- Direkte Treffen mit den Büros gewählter Amtsträger durchführen
...
- Was sind meine Fähigkeiten? Wenn Sie dies wissen, können Sie bestimmen, auf welche Aspekte Ihres Plans Sie sich konzentrieren möchten und welche Aspekte Sie an andere delegieren möchten. Stellen Sie sicher, dass Sie zumindest einige Fähigkeiten in den Bereichen der Kampagne haben, die Sie umsetzen möchten.
...
- Stellen Sie sicher, dass jede Ihrer bevorzugten Taktiken in Ihr Gesamtziel passt. Wenn Ihr Ziel beispielsweise darin besteht, gewählte Amtsträger zu überzeugen, und Ihre Taktiken den Aufbau von Allianzen mit Gemeinschaftsgruppen beinhalten, sollten Sie eine klare Vorstellung davon haben, warum und wie der Aufbau von Allianzen mit Gemeinschaftsgruppen dazu führen kann, dass gewählte Amtsträger überzeugt werden, zu handeln.
- Die Zuweisung eines numerischen Wertes zu Ihren Zielen und Taktiken kann Ihre Planung konkreter machen. Zum Beispiel könnten Ihre Taktiken darin bestehen, ein Team von 10 Freiwilligen aufzubauen, 50 Briefe an Kongressbüros zu schreiben, 3 Artikel in lokalen Nachrichtenagenturen zu veröffentlichen usw.
...
### Beispiel für einen Kampagnenplan {#sample-campaign-plan}

Hier ist ein gekürzter Beispielkampagnenplan für weitere Anleitung:

**Ziel**: Meinen US-Vertreter und Senatoren davon überzeugen, öffentlich ein internationales Abkommen zur Einführung eines Moratoriums für die Entwicklung von Grenz-KI zu unterstützen.

**Strategie**:

1. Die öffentliche Sichtbarkeit von KI-Risiken erhöhen.
...
- Direkte Treffen mit Kongressbüros durchführen und unsere politischen Vorschläge vorstellen.
...
- Veranstaltungen mit der Zustimmung von Freiwilligen planen.
- Treffen mit Kongressbüros planen.
...
Eine allgemeine bewährte Praxis besteht darin, Informationen über Ihre Gruppe, ihre Ziele und Initiativen sowie darüber, wie Gemeindemitglieder sich einbringen können, bereitzustellen.
...
Sie sind wahrscheinlich von vielen bestehenden Interessengruppen umgeben. Diese Gruppen haben bereits Mitglieder, die motiviert sind und aktiv ehrenamtlich tätig sind – einige davon möchten sich vielleicht bei PauseAI einbringen.
...
- Umwelt- und Klimapolitikgruppen, einschließlich lokaler Kapitel nationaler Organisationen. (Diese Gruppen sind bereits mit existenziellen Risiken durch den Klimawandel vertraut und könnten für existenzielle Risiken durch KI empfänglicher sein).
- [Lokale Kapitel von Effective Altruism](https://forum.effectivealtruism.org/groups#local).
...
Wenn Sie Student sind, hat Ihre Hochschule oder Universität möglicherweise eine öffentliche Liste von Studentenorganisationen, die Sie nach Kategorie sortieren können.

#### Eine überzeugende Kontaktnachricht erstellen {#crafting-a-compelling-outreach-message}

Wenn Sie eine Gruppe kontaktieren, sollte Ihre erste Nachricht:

- PauseAI und Ihre Ziele als lokales Kapitel erklären;
- erklären, wie Ihr lokales Kapitel mit den Zielen der Gruppe, die Sie kontaktieren, zusammenhängt und warum sich Mitglieder dafür interessieren könnten;
- mit einer "Aufforderung" und einigen nächsten Schritten enden. Diese "Aufforderung" kann das Anfordern eines Treffens zur Diskussion einer Zusammenarbeit im Detail, das Anfordern, dass die Gruppe Informationen über PauseAI an ihre Freiwilligenliste weiterleitet, das Anfordern, bei einer bevorstehenden Gruppensitzung zu sprechen usw. umfassen.
...
Genau wie fossile Brennstoffunternehmen Bemühungen zur Reduzierung der Emissionen untergraben haben, finanzieren auch KI-Unternehmen Bemühungen, um menschliches Niveau zu erreichen, trotz der Tatsache, dass Experten [zugeben](https://blog.aiimpacts.org/p/2023-ai-survey-of-2778-six-things), dass diese Systeme die Zivilisation bedrohen könnten. Diese Angelegenheit hängt direkt mit dem Klimarisiko zusammen, da KI-Trainingsläufe große Mengen an Energie erfordern, die oft aus fossilen Brennstoffen stammen.

Wir müssen unsere gewählten Amtsträger unter Druck setzen, diese Technologien zu regulieren. Angesichts der Arbeit, die Ihre Organisation bei der Erreichung von Klimapolitik geleistet hat, dachte ich, dass sich einige Ihrer Mitglieder für diese Gelegenheit interessieren könnten.

Können Sie unsere Informationen an Ihre Freiwilligenliste weiterleiten? Nachfolgend finden Sie einen Link zu unserer öffentlichen Seite. Ich wäre auch gerne bereit, einen Anruf zu planen und dies weiter zu diskutieren.
...
Eine weitere Möglichkeit, Freiwillige aus bestehenden Gruppen zu rekrutieren, besteht darin, sich selbst einzuladen, bei diesen Gruppensitzungen zu sprechen.
...
Das Sprechen bei Gruppensitzungen – oder bei jeder öffentlichen Veranstaltung – gibt Ihnen die Gelegenheit, Menschen dazu zu bringen, sich PauseAI anzuschließen.
...
- **Einführung**: Wer Sie sind und warum Sie hier sind.
  - Warum sind Sie als Einzelperson motiviert zu handeln? Was ist Ihre Geschichte?
  - Beispiel: Ich habe gerade das Kapitel meiner Stadt von PauseAI gegründet, und ich bin hier, um mehr über die Risiken fortschrittlicher KI, wie wir diese Risiken verhindern können und wie Sie sich einbringen können, zu teilen.
- **Problem**: Was ist das Problem, und warum sollte sich Ihr Publikum dafür interessieren? Wie hängt das Problem mit den Interessen Ihres Publikums zusammen?
  ...
  - Beispiel: KI-Systeme entwickeln sich rasant. KI-Unternehmen haben das Ziel, Systeme zu entwickeln, die intelligenter und leistungsfähiger sind als Menschen, trotz der Tatsache, dass Sicherheitsexperten uns sagen, dass wir nicht wissen, wie wir diese Systeme kontrollieren können. Eine mögliche Folge von KI auf übermenschlichem Niveau ist die Entmachtung oder Ausrottung der Menschheit.
- **Lösung**: Wie können wir das Problem lösen? (Dieser Abschnitt ist mehr auf die große Vision und weniger auf spezifische Taktiken ausgerichtet.)
  - Beispiel: Wir brauchen ein globales Moratorium für die Entwicklung von Grenz-KI, um zu verhindern, dass Unternehmen so schnell wie möglich menschliches Niveau erreichen und um uns mehr Zeit zu geben, herauszufinden, wie wir diese Systeme sicher machen können.
- **Strategie**: Wie erreichen wir unsere vorgeschlagene Lösung? Was hat unsere Gruppe zu bieten, um diese Lösung zu ermöglichen?
  - Beispiel: Wir müssen die öffentliche Sichtbarkeit von KI-Risiken erhöhen und gewählte Amtsträger direkt unter Druck setzen, ein Moratorium zu unterstützen. Wir können dies tun, indem wir die Öffentlichkeit über die Risiken von KI aufklären und direkt mit gewählten Amtsträgern sprechen.
...
- **Aufruf zum Handeln**: Wie kann Ihr Publikum sich sofort einbringen?
...
Viele Hochschulen und Universitäten haben öffentliche Verzeichnisse, die Kursangebote und Kontakte zu Lehrkräften auflisten. Relevante Abteilungen und Kurse, die Sie in Betracht ziehen sollten, sind:
...
1. Stellen Sie sich und Ihre lokale PauseAI-Gruppe vor
2. Erklären Sie, warum sich die Studenten des Professors für PauseAI interessieren könnten (d.h. seine Relevanz für den Kurs)
3. Bitten Sie den Professor, Informationen über Ihre PauseAI-Gruppe an seine Klasse weiterzuleiten

Hier ist eine Beispiel-E-Mail für weitere Inspiration:

**BETREFF**: KI-Politikgelegenheit, um mit Studenten zu teilen
...
Wir haben kürzlich ein lokales Kapitel in (Stadt) gegründet, und ich dachte, dass sich einige Ihrer Studenten dafür interessieren könnten. Wir werden uns treffen, um KI-Politikvorschläge zu diskutieren, Bildungsveranstaltungen zu den Gefahren von KI durchzuführen, an Nachrichtenagenturen und gewählte Amtsträger zu schreiben und vieles mehr. Weitere Informationen finden Sie unten.
...
**PauseAI (Stadt)**: Gelegenheit, sich in die lokale KI-Politik einzubringen
...
PauseAI ist eine internationale Bewegung, die darauf abzielt, die Risiken durch leistungsfähige künstliche Intelligenz zu mindern, bis wir wissen, wie wir sie sicher machen können. Unser lokales Kapitel wird regelmäßig Bildungsveranstaltungen zu KI-Politik durchführen, das Bewusstsein für KI-Risiken durch Medien schärfen und unsere gewählten Amtsträger kontaktieren, um robuste politische Lösungen für KI-Schäden zu unterstützen.
...
Eine gut geführte lokale Gruppe erfordert, dass Sie sich regelmäßig mit einzelnen Freiwilligen treffen und Gruppensitzungen durchführen, an denen alle Freiwilligen teilnehmen können.
...
Das Gesamtziel besteht darin, aus diesen Gesprächen mit 1) einem klaren Verständnis der Rolle und Verantwortung jedes Freiwilligen und 2) spezifischen nächsten Schritten, die Freiwillige unternehmen können, hervorzugehen.
...
Dies gibt Ihnen die Gelegenheit, teamweite Updates zu teilen, Prioritäten zu diskutieren und Veranstaltungen und Initiativen zu planen.
...
- **Runden**: Von jedem nacheinander zu einem bestimmten Thema oder einer bestimmten Frage hören.
...
### Beispiel für eine Team-Sitzungsagenda {#sample-team-meeting-agenda}

Hier ist eine Beispielagenda für eine Team-Sitzung für Inspiration:

- **Aktualisierungen aus der Vorwoche(n)**
  - Jeder Freiwillige teilt mit, woran er seit der letzten Sitzung gearbeitet hat
  - Diskutieren Sie, wie diese Aktualisierungen in die Gesamtziele der Gruppe passen
- **Aktuelle Prioritäten und Strategie diskutieren**
  ...
  - Diskutieren Sie bevorstehende Veranstaltungen und Initiativen - Prioritäten für die kommenden Wochen
...
Wenn Ihr Team wächst, werden sich verschiedene Freiwillige auf unterschiedliche Weise einbringen wollen. Dies zu fördern ist eine großartige Möglichkeit, Ihre Gruppe zu stärken, damit jeder Freiwillige seinen eigenen Beitrag zur Bewegung leisten kann.
...
Hier ist eine Beispiel-Tabelle von Rollen für Inspiration:
(Dies soll nur ein illustratives Beispiel für mögliche Rollen geben; verschiedene Gruppen können sehr unterschiedliche Rollen haben, je nach ihren Prioritäten und Interessen.)
...
|        | Koalitionsaufbau                   | Kontaktiert andere Gruppen, um Nachrichten und Informationen über PauseAI zu teilen. Spricht bei Sitzungen anderer Gruppen. Teilt Informationen über bevorstehende Veranstaltungen und rekrutiert Teilnehmer aus anderen Gruppen.                                                   |            |
|        | Kongresskoordinator                | Plant Briefkampagnen und Telefonkampagnen zu Kongressbüros. Organisiert Veranstaltungen, die die Öffentlichkeit dazu ermutigen, ihre Kongressabgeordneten wegen KI anzurufen. Plant Treffen mit Kongressbüros, um den Vertragsvorschlag von PauseAI zu diskutieren.   |            |
...
Es gibt viele verschiedene Möglichkeiten, Ihre Ziele als lokale Gruppe zu erreichen.
Überprüfen Sie unsere [Veranstaltungsseite](/events), um Ideen für die nächsten Veranstaltungen zu erhalten, die geplant sind. Wenn Sie sich entscheiden, eine Veranstaltung zu organisieren, vergessen Sie nicht, sie dort hinzuzufügen!
...
- **Happy Hour**: Treffen Sie sich in einer lokalen Bar oder einem Restaurant für Getränke und Geselligkeit.
- **Potlucks**: Lassen Sie Freiwillige Essen mitbringen, um es in einem lokalen Park oder Gemeindezentrum zu teilen.
- **Spielabende**: Veranstalten Sie einen Spielabend in einem Haus oder einem lokalen Spielwarenladen.
...
### Öffentliche Teach-Ins und Aktionsitzungen zu KI-Risiken {#public-teach-ins-and-action-sessions-on-ai-risk}
...
#### Beispiel für eine Veranstaltungsagenda (für eine Aktionsitzung zum Kongresskontakt) {#sample-event-agenda-for-an-action-session-on-congressional-outreach}

- **Einführung / soziales Mischen**
- **Präsentationssitzung**
  - PauseAI vorstellen
  - KI-Risiken diskutieren
  - Den Vertragsvorschlag von PauseAI beschreiben
  - Die Bedeutung des Kongresskontakts erklären
- **Briefschreibsitzung**
  - Beste Praktiken für das Schreiben an Ihren Kongressabgeordneten durchgehen
  - Teilnehmer auffordern, handschriftliche Briefe an ihren Kongressabgeordneten zu schreiben
  - Umschläge und Briefmarken für die Teilnehmer bereitstellen, um Briefe zu verschicken
- **Teilnehmer auffordern, sich bei PauseAI zu engagieren**

### Dokumentarfilmvorführungen zu KI-Risiken {#movie-documentary-screenings-on-ai-risk}

Ähnlich wie bei einem öffentlichen Teach-In, aber mit einem Dokumentarfilm anstelle einer Präsentation. Dies kann eine gute Möglichkeit sein, die Öffentlichkeit zu engagieren. Bonuspunkte, wenn Sie Popcorn und Snacks beschaffen.
Genau wie bei einem Teach-In sollten Sie die Teilnehmer auffordern, sofort nach der Vorführung zu handeln, z.B. indem sie ihren Kongressabgeordneten schreiben oder anrufen.
...
- **Die Bedeutung von Medienkontakt erklären**
- **Beste Praktiken für das Schreiben an Medienagenturen durchgehen**
- **Eine Schreibsitzung durchführen (20-30 Minuten)**
  - Freiwillige auffordern, Leserbriefe zu entwerfen und Feedback zu den Schriften der anderen zu geben
  - Freiwillige auffordern, ihre Leserbriefe an bestimmte Zeitungen einzureichen

### Flyer-Verteilung und Tische aufstellen {#flyering--tabling-sessions}

Auch nachdem Sie eine Basis von Freiwilligen haben, können Sie weiterhin Flyer verteilen und [Tische aufstellen](/tabling), um das Wort an die Öffentlichkeit zu bringen.
...
Es gibt mehrere Möglichkeiten, kostenlose oder billige Versammlungsräume zu beschaffen, solange Sie im Voraus planen. Hier sind einige Ideen.

- **Öffentliche Bibliotheken**: Viele Bibliotheken bieten kostenlose Versammlungsräume für Gemeindegruppen, gemeinnützige Organisationen und Bildungssitzungen an. Sie müssen möglicherweise im Voraus buchen und die Richtlinien der Bibliothek einhalten.
- **Gemeindezentren**: Lokale Gemeindezentren haben oft Räume, die kostenlos genutzt werden können. Diese Zentren zielen darauf ab, lokale Aktivitäten zu unterstützen und priorisieren möglicherweise lokale Einwohner und Gemeindegruppen.
- **Universitäten und Hochschulen**: Bildungseinrichtungen bieten manchmal kostenlose Räume für Versammlungen an, insbesondere für Alumni oder gemeindeorientierte Veranstaltungen. Kontaktieren Sie die Veranstaltungsabteilung oder das Büro für Gemeindebeziehungen der Einrichtung für weitere Informationen.
- **Lokale Unternehmen und Cafés**: Einige Unternehmen, wie Cafés und Buchhandlungen, haben Räume, die während der Stoßzeiten für Versammlungen genutzt werden können. Es wird oft erwartet, dass die Teilnehmer etwas im Geschäft kaufen.
- **Online-Plattformen**: Websites wie EventBrite oder Facebook-Gruppen können Ressourcen für das Finden gemeinsam genutzter Räume sein, die kostenlos verfügbar sind. Gemeinschaftstafeln listen häufig verfügbare Räume auf.
- **Gemeindegebäude**: Rathäuser und andere Gemeindegebäude haben häufig Räume, die für die öffentliche Nutzung verfügbar sind. Diese sind normalerweise kostenlos, erfordern aber möglicherweise den Nachweis, dass die Versammlung der Gemeinschaft zugutekommt.
...
- **Parks und Außenanlagen**: Für weniger formelle Versammlungen oder Zusammenkünfte sollten Sie einen lokalen Park in Betracht ziehen. Stellen Sie sicher, dass Sie prüfen, ob Sie eine Genehmigung benötigen, insbesondere für größere Gruppen oder spezielle Einrichtungen.

Wenn Sie kostenlose Räume nutzen, ist es höflich, den Raum so zu verlassen, wie Sie ihn vorgefunden haben, und sich bei dem Anbieter zu bedanken. Dies hilft, eine gute Beziehung aufrechtzuerhalten und erhöht die Wahrscheinlichkeit, dass der Raum für zukünftige Nutzung verfügbar ist.

### Hinweis: Best Practices für die Veranstaltungsplanung {#note-finding-space-for-public-in-person-events}

- Laden Sie Teilnehmer zu öffentlichen Veranstaltungen ein. Wenn Sie eine öffentlich zugängliche Veranstaltung durchführen, ist es wichtig, dies weit im Voraus zu tun. Sie können ein Facebook- oder Meetup-Event erstellen, die Veranstaltung bewerben, indem Sie sie mit anderen Gruppen teilen, und die Teilnahme aufbauen.
- Stellen Sie sicher, dass die Adresse, die Sie den Leuten geben, Anweisungen über die Straßenadresse hinaus enthält, wenn nötig. Wenn Sie beispielsweise einen Tisch aufstellen, aber keine genauen Anweisungen zu Ihrem Tisch innerhalb des Gebäudes haben, wird eine überraschend große Anzahl neuer Mitglieder einfach aufgeben. Ein Tischschild (Fotos bei Walmart für 1 $ pro Stück drucken) kann auch erheblich helfen.
- Fügen Sie Veranstaltungen ein soziales Element hinzu. Stellen Sie sicher, dass es Zeit für soziales Mischen und das Aufbauen eines Gemeinschaftsgefühls gibt. Fügen Sie der Veranstaltungsagenda unstrukturierte Zeit hinzu, damit sich die Leute vorstellen und mischen können.
...
- Fügen Sie immer Follow-up und nächste Schritte am Ende der Veranstaltung hinzu. Geben Sie den Teilnehmern eine klare Vorstellung davon, was sie tun können, um bei PauseAI weiterhin involviert zu bleiben.

## Überwindung von Hindernissen bei der lokalen Organisation {#note-best-practices-for-event-planning}

### Hindernis 1: Schwierigkeiten, Ihre Gruppe in Gang zu bringen {#overcoming-obstacles-in-local-organizing}

Sie könnten Schwierigkeiten haben, Freiwillige zu finden. Vielleicht scheinen die Leute, mit denen Sie sprechen, nicht interessiert zu sein, Ihre Flyer-Verteilungssitzungen verlaufen nicht gut, und Sie können keine bestehenden lokalen Gruppen dazu bringen, Ihre E-Mails zu beantworten.

**Wie man es überwindet**:

- Nutzen Sie Ihr persönliches Netzwerk so viel wie möglich. Kontaktieren Sie jeden, den Sie kennen, der sich möglicherweise für eine Beteiligung interessiert, und fragen Sie ihn, ob er jemanden kennt, mit dem Sie sprechen könnten. Ebenso sollten Sie, wenn Sie jemanden in einer lokalen Gruppe kennen, ihn persönlich kontaktieren.
...
- Stellen Sie sicher, dass Ihre Nachrichten und E-Mails an Gruppen klar und direkt sind und eine spezifische Anfrage enthalten. Sie können auch Ihre E-Mail-Entwürfe an den PauseAI-Discord senden und Feedback erhalten.
- Wenn Gruppen nicht auf Sie reagieren, könnten Sie nicht genug Gruppen kontaktieren. Ziehen Sie in Betracht, sich an mehr Gruppen zu wenden, auch wenn ihr Fokus nur lose oder tangential mit KI zusammenhängt.

### Hindernis 2: Mangel an Fokus {#obstacle-1-difficulty-getting-your-group-off-the-ground}

Sie könnten einen Zustrom von Freiwilligen haben, die sich vage einbringen möchten, aber keine klare Vorstellung davon haben, wie sie helfen möchten.
Dies kann Ihre Gruppe desorganisiert machen, mit vielen Ideen, aber ohne einen klaren Plan, um sie umzusetzen.

**Wie man es überwindet**:

- Die ersten Gespräche mit Freiwilligen könnten möglicherweise keine klare Vorstellung davon vermitteln, welche Rollen und Verantwortlichkeiten sie übernehmen könnten. In diesem Fall können Sie zusätzliche Einzelgespräche planen und tiefer in diese Fragen eintauchen. Das Ziel dieser zusätzlichen Einzelgespräche sollte darin bestehen, das Verständnis davon zu festigen, wie sich jeder Freiwillige einbringen kann, und einen spezifischen Follow-up-Plan zu erstellen, um die Verantwortlichkeit sicherzustellen.
- Wenn Team-Sitzungen "zu viel Gerede und nicht genug Aktion" sind, müssen Sie möglicherweise die Sitzungsagenda umstrukturieren, um mehr Zeit am Ende für konkrete Planung einzuplanen. Bitten Sie Freiwillige, im Raum herumzugehen und aufzulisten, was sie vor der nächsten Sitzung tun werden.

- Es ist auch hilfreich, zwischen den Sitzungen mit Freiwilligen Kontakt aufzunehmen, um zu sehen, wie es ihnen mit ihren Verantwortlichkeiten geht, und ob sie Fragen haben oder Hilfe bei etwas benötigen. Dies kann sogar nur eine schnelle Kontrollnachricht sein.

### Hindernis 3: Ihre Gruppe "verpufft" aufgrund nachlassenden Interesses von Freiwilligen {#obstacle-2-lack-of-focus}

Freiwillige könnten anfangs begeistert sein, sich einzubringen, aber im Laufe der Zeit das Interesse verlieren.
Dies kann passieren, weil Freiwillige sich nicht motiviert fühlen, die Aktionen, die sie interessieren, nicht mögen oder einfach erkennen, dass ehrenamtliche Arbeit nicht für sie geeignet ist.
...
Wenn Sie bei irgendeinem Aspekt der lokalen Organisation Schwierigkeiten haben, können Sie dies auch im local-organizers-Kanal auf dem [PauseAI-Discord](https://discord.gg/2XXWXvErfA) diskutieren, und andere werden Ihnen gerne helfen und Feedback geben.