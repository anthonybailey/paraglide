...
Die Festlegung einer roten Linie, die bestimmt, welche Art von Technologien und Aktionen entwickelt und durchgeführt werden können, ist etwas, was wir ständig tun.

## Politische Machbarkeit einer Pause {#political-feasibility-of-a-pause}

Einige haben die Pause als "radikal" oder "extrem" bezeichnet, aber das ist nicht, wie die Öffentlichkeit darüber denkt.
...
- Die überwiegende Mehrheit (>60%) [einen internationalen Vertrag zur Ächtung von AGI unterstützt](https://www.sentienceinstitute.org/aims-survey-supplement-2023)

## Technische Durchsetzbarkeit einer Pause {#technical-enforceability-of-a-pause}

Der einfachste Weg, um Vorreiter-Modelle zu regulieren, ist die [Regulierung der Rechenleistung](https://www.governance.ai/post/computing-power-and-the-governance-of-ai).
...
- ASML ist das einzige Unternehmen, das EUV-Lithographie-Maschinen produziert
...
Außerdem ist es wichtig zu beachten, dass Vorschriften Unternehmen langfristig nützen können, da sie durch regulatorische Einnahmen nicht die Verbraucher verlieren, wenn die Gefahren real werden, und Konkurrenten benachteiligen.
Wir müssen also vorsichtig sein, dass wir nicht nur eine Pause erreichen, sondern dass sie nicht aufgehoben wird, bis es tatsächlich sicher ist, die Entwicklung von Vorreiter-KI fortzusetzen.

## Macht über Regierungen {#power-over-governments}

Wenn du befürchtest, dass Regierungen deine Sicherheit nicht ernst nehmen, ist das ein komplexes Problem.
Aber im Allgemeinen kümmern sich Politiker darum, nicht die politische Unterstützung zu verlieren.
Und wichtiger noch, sie können auch besorgt über die Risiken sein, ohne die riesige Voreingenommenheit und rechtlichen Verpflichtungen, die einige Einzelpersonen aus Unternehmen haben, um die Gewinne zu maximieren.

Wenn du denkst, dass wir die Regulierung einer einzelnen Regierung erreichen könnten, aber nicht einen multilateralen Vertrag, musst du erkennen, dass, wenn Regierungen erkennen, dass einige unkontrollierbare Technologien eine Gefahr für ihre Bevölkerung darstellen und aus anderen Nationen stammen können, die neuen Technologien zu einem nationalen Sicherheitsproblem werden und die Regierungen daran interessiert sind, andere Länder davon abzuhalten, sie zu entwickeln.
Außerdem ist es wichtig zu erkennen, dass wir nicht wirklich viele Länder brauchen, um einer Pause zuzustimmen.
In Wirklichkeit kann man eine Pause in der Entwicklung von Vorreiter-Modellen erreichen, indem man sie nur in den USA (und sogar nur in Kalifornien) verbietet.
...
Für empirische Beweise dafür, dass ein Vertrag wie dieser möglich ist, sollten wir uns an vergangene globale Vereinbarungen erinnern.
...
- Das [Montreal-Protokoll](https://de.wikipedia.org/wiki/Montrealer_Protokoll), das die Produktion von FCKWs in allen 197 Ländern verbot und als Folge dazu führte, dass die globalen Emissionen von ozonabbauenden Substanzen seit 1986 um mehr als 99% zurückgegangen sind. Dank des Protokolls heilt das Ozonloch jetzt, und das ist, warum wir nicht mehr davon hören.
...
- Die [Umweltänderungskonvention](https://de.wikipedia.org/wiki/Übereinkommen_über_das_Verbot_militärischer_oder_jeder_anderen_feindseligen_Nutzung_umweltverändernder_Techniken), die Wetterkrieg verbot und von 78 Staaten unterzeichnet wurde.
...
- Die [Internationale Atomenergie-Organisation](https://de.wikipedia.org/wiki/Internationale_Atomenergie-Organisation), die eine zwischenstaatliche Organisation ist, die aus 178 Mitgliedstaaten besteht und sich für die friedliche Nutzung von Nuklearenergie einsetzt und ihre Nutzung für militärische Zwecke verhindern will. Unabhängig davon, ob du denkst, dass Nuklearenergie überreguliert ist oder nicht, wird die IAEO als gutes Beispiel für ein internationales Instrument angesehen, das wir haben könnten, um die Sicherheit der größten KI-Modelle zu bewerten.
...
Wenn du denkst, dass KI tatsächlich ähnlich anderen Fällen ist, in denen wir es nicht geschafft haben, gute Verträge international zu schließen: alles, was jemals passiert ist, hatte ein erstes Mal.
...
Wenn du die Idee von Protesten nicht magst, unternehmen wir auch [andere Aktionen](/action), wie das direkte Kontaktieren von [Regierungen](/lobby-tips).
...
Zum Beispiel [versuchen wir nicht, bestehende Produkte und Dienstleistungen zu regulieren, die Menschen bereits nutzen und regelmäßig verwenden](/proposal), und wir gehen nicht gegen viele Unternehmen vor, die lobbyieren können oder Arbeiter, die ihre Jobs verlieren würden, wenn wir erfolgreich sind. Ziemlich das Gegenteil.
...
Die Information der Öffentlichkeit, der Techniker und der Politiker über die Risiken hilft anderen Interventionen, die darauf abzielen, sichere KI und sichere KI zu machen.
Es veranlasst die Menschen, der technischen, politischen und kommunikativen Arbeit, die in KI-Sicherheit und KI-Ethik geht, mehr Bedeutung beizumessen, was letztendlich bedeutet, dass mehr Mittel und Arbeitsplätze in sie fließen, mit dem Ziel, bessere Ergebnisse zu erzielen.
...
Außerdem könnte es die Menschen einigermaßen auf die Gefahren vorbereiten, ihnen beibringen, wie man KI ethischer nutzt, und sie sogar davon überzeugen, nicht in Vorreiter- und unsichere Projekte zu investieren oder daran zu arbeiten.
...
Das einzige einfache ist aufzugeben, [es ist der einfache Ausweg](/psychology-of-x-risk#difficult-to-act-on).
...
Auch wenn du glaubst, dass eine Pause ziemlich unwahrscheinlich ist und du dich nicht um die anderen Vorteile kümmerst, empfehlen wir dir, [dich anzuschließen](/join). Vergrabe deinen Kopf nicht in den Sand und warte darauf, zu sterben oder gerettet zu werden, du kannst uns helfen, dies zu erreichen!